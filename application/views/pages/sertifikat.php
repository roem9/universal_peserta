            ...
            <div class="page-body">
                <div class="container-xl">
                    <div class="row justify-content-center">
                        <div class="col-12">
                            <center>
                                <img src="<?= $link_foto[0]['value']?>/assets/img/logo.png" width=150 class="img-fluid mb-3" alt="">
                            </center>
                        </div>
                                ...
                                <?php if(isset($nama)) :?>
                                    <div class="card shadow mb-4">
                                        ...
                                        <div class="card-body text-gray-900">
                                            <center><img src="<?= $link_foto[0]['value']?>/assets/foto/<?= $file?>" class="mb-3" width=150 alt=""></center>
